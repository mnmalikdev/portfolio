  ...
  return (
    <div className="flex flex-col px-24 py-11 mt-10   ">
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm tracking-wide ml-2">
            ...
            <p className="mt-4 text-sm text-gray-800">
              Skilled in React.js, JavaScript, TypeScript, Node.js, and Nest.js. Strong engineering professional with a fine eye for UI/UX design.
            </p>
            <p className="mt-4 text-sm text-gray-800">
      ...
      <div className="flex flex-col-reverse justify-center pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-gray-600">© Copyright 2022 mnmalikdev. All rights reserved.</p>
      </div>
    </div>
  );
};
